...
export const projects: ProjectConfig[] = [
  {
    ...
    checks: [
      ...
      { name: 'api-banners', type: 'api', path: '/api/banners' },
      { name: 'api-configuracion', type: 'api', path: '/api/configuracion' },
      { name: 'admin', type: 'admin', path: '/admin' },
    ],
  },
  {
    ...
    checks: [
      { name: 'frontend', type: 'frontend', path: '/' },
      { name: 'api-services', type: 'api', path: '/api/services' },
      { name: 'admin', type: 'admin', path: '/admin' },
    ],
  },
  {
